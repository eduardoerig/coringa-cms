...
export const sectionRegistry: Record<string, SectionRegistryEntry> = {
  ...
  canvas: {
    ...
    fields: [
      ...
      { key: "bgColor", label: "Cor de fundo da tela", type: "color", placeholder: "Transparente", category: "appearance", group: "Tela" },
      { key: "bgImage", label: "Imagem de fundo da tela", type: "image", category: "appearance", group: "Tela" },
      {
        key: "grid",
        label: "Grade (encaixe)",
        type: "select",
        ...
        options: [
          ...
          { value: "10", label: "Fina (10px)" },
          { value: "20", label: "Média (20px)" },
          { value: "40", label: "Grande (40px)" },
        ],
      },
      ...SECTION_GROUP(),
    ],
