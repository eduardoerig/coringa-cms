...
export function WhatsAppButton({ 
  ...
  useEffect(() => {
    // Aparecer após 2s de navegação
    const timer = setTimeout(() => setVisible(true), 2000);
    // Esconder tooltip após 6s
      ...
      {visible && (
        ...
        >
          ...
          <a
            ...
            className="group w-[60px] h-[60px] bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.55)] hover:scale-110 active:scale-95 transition-all duration-300"
          >
            ...
            {/* Pulse ring */}
            <span className="absolute w-[60px] h-[60px] rounded-full bg-[#25D366]/30 animate-ping pointer-events-none" />
          </a>
        </motion.div>
      )}
    </AnimatePresence>
